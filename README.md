...
## 🚀 **Sobre o Projeto**
Este projeto foi desenvolvido para um teste técnico para a posição de Analista de Sistemas - Angular do ***Grupo Nexxees***. A aplicação é uma SPA (Single Page Application) desenvolvida em Angular, que permite aos usuários:
